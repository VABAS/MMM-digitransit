Module.register("digitransit",{
	...
	getDom: function () {
		...
		table.setAttribute("style", "align:left; width:" + self.config.width + "px;");
		var tr = document.createElement("tr");
		var rtindth = document.createElement("th");
		rtindth.setAttribute("style", "width:10px;");
		var timeth = document.createElement("th");
		timeth.setAttribute("style", "width:60px;");
